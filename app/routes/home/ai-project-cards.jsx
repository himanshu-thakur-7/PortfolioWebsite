...
const projects = [
  ...
  {
    title: 'Revenant.AI — The Autonomous Outbound Engineer',
    subtitle: 'Hunts pain → ships a working prototype → films an AI walkthrough',
    description:
      'For each prospect it mines public pain signals, generates a personalized microsite + working prototype deployed to Cloudflare Pages, records an ElevenLabs-narrated Loom-style walkthrough, and drafts the outreach into a Convex-backed human-review console. Built on Hermes (Nous Research) for the GrowthX × Hermes buildathon.',
    metrics: [
      { label: 'Orchestrator', value: 'Hermes' },
      { label: 'Per-prospect', value: 'Live prototype' },
    ],
    tags: ['Hermes', 'Convex', 'Cloudflare', 'OpenAI', 'ElevenLabs', 'React'],
    link: 'https://github.com/himanshu-thakur-7/Revenant.AI',
    demoLink: 'https://revenantai-app.vercel.app/',
    blogLink: null,
    icon: 'revenant',
    accent: '#a78bfa',
  },
